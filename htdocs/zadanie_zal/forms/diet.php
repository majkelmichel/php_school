...
<body>
    <div class="container">
        <h1 class="mt-5">Dodaj Obiekt Diet</h1>
        <form method="post" action="diet.php">
            ...
            <div class="form-group">
                <label for="location">Diet no</label>
                <input type="number" class="form-control" id="diet" name="diet" placeholder="Object diet no">
            </div>
        ...
        <?php
            ...
            if (
                ...
                try {
                    ...
                    $diet = $connection->real_escape_string($_POST['diet']);

                    if ($connection->connect_errno != 0) {
                        echo "Nie połączono z bazą!";
                    }
                    else {
                        $query = "INSERT INTO diet_objects VALUES (NULL, '$name', '$location', '$role', '$diet')";
