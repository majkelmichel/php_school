...
<body>
    <div class="container">
        <h1 class="mt-5">Dodaj Obiekt Senate</h1>
        <form method="post" action="senate.php">
            ...
            <div class="form-group">
                <label for="location">Senate no</label>
                <input type="number" class="form-control" id="senate" name="senate" placeholder="Object senate no">
            </div>
        ...
        <?php
            ...
            if (
                ...
                try {
                    ...
                    $senate = $connection->real_escape_string($_POST['senate']);

                    if ($connection->connect_errno != 0) {
                        echo "Nie połączono z bazą!";
                    }
                    else {
                        $query = "INSERT INTO senate_objects VALUES (NULL, '$name', '$location', '$role', '$senate')";
