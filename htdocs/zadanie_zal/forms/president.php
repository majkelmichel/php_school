...
<body>
    <div class="container">
        <h1 class="mt-5">Dodaj Obiekt President</h1>
        <form method="post" action="president.php">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="surname" name="surname" placeholder="Object surname">
            </div>
            <div class="form-group">
            ...
            if (
                ...
                try {
                    ...
                    if ($connection->connect_errno != 0) {
                        ...
                        $query = "INSERT INTO president_objects VALUES (NULL, '$name', '$location', '$political', '$surname')";
